...
public class Constants
{
    ...
    public static final String REST_V1_BOOKS = "/v1/books";
    public static final String REST_V1_AUTHORS = "/v1/authors";
    public static final String REST_V1_REVIEWS = "/v1/reviews";
